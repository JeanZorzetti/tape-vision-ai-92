# 🚀 Production Deployment Checklist - apitapevision.roilabs.com.br
...
9. [ ] Add Custom Domain: `apitapevision.roilabs.com.br`
...
5. [ ] `flyctl certs add apitapevision.roilabs.com.br`
...
- [ ] `curl https://apitapevision.roilabs.com.br/`
  - Expected: API information JSON

### 2. API Documentation
- [ ] Visit: https://apitapevision.roilabs.com.br/v1/docs
...
BASE_URL = "https://apitapevision.roilabs.com.br"
python test_api.py
```
